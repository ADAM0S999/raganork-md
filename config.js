...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://c4.wallpaperflare.com/wallpaper/628/1009/137/leonardo-watch-kekkai-sensen-anime-anime-boys-wallpaper-preview.jpg Hey {sender}, I'm DODO \n Uptime: {uptime}",
    ...
    STICKER_DATA: process.env.STICKER_DATA || "DODO",
    BOT_NAME: process.env.BOT_NAME || 'DODO',
